...
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
/// @note float_array must not be null.
/// @note The returned pointer is valid until the array is destroyed.
/// @note The data can be safely accessed up to nusd_float_array_size()
/// elements.
NANOUSD_API
...
///
/// @param float2_array Valid float2 array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
///
/// @param float3_array Valid float3 array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
///
/// @param float4_array Valid float4 array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
/// @note double_array must not be null.
/// @note The returned pointer is valid until the array is destroyed.
/// @note The data can be safely accessed up to nusd_double_array_size()
/// elements.
NANOUSD_API
...
///
/// @param double_array Valid double array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
///
/// @param double2_array Valid double2 array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
///
/// @param double3_array Valid double3 array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
///
/// @param double4_array Valid double4 array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
/// @note int64_array must not be null.
/// @note The returned pointer is valid until the array is destroyed.
/// @note The data can be safely accessed up to nusd_int64_array_size()
/// elements.
NANOUSD_API
...
/// @param matrix2d_array Valid matrix2d array handle.
///
/// @return Pointer to the matrix2d data. Each matrix2d is stored as 4
/// consecutive doubles in row-major order.
///
/// @note matrix2d_array must not be null.
/// @note The returned pointer is valid until the array is destroyed.
/// @note Total data size is nusd_matrix2d_array_size(matrix2d_array) * 4 *
/// sizeof(double).
NANOUSD_API
...
///
/// @param matrix2d_array Valid matrix2d array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
/// @param matrix3d_array Valid matrix3d array handle.
///
/// @return Pointer to the matrix3d data. Each matrix3d is stored as 9
/// consecutive doubles in row-major order.
///
/// @note matrix3d_array must not be null.
/// @note The returned pointer is valid until the array is destroyed.
/// @note Total data size is nusd_matrix3d_array_size(matrix3d_array) * 9 *
/// sizeof(double).
NANOUSD_API
...
///
/// @param matrix3d_array Valid matrix3d array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
/// @param matrix4d_array Valid matrix4d array handle.
///
/// @return Pointer to the matrix4d data. Each matrix4d is stored as 16
/// consecutive doubles in row-major order.
///
/// @note matrix4d_array must not be null.
/// @note The returned pointer is valid until the array is destroyed.
/// @note Total data size is nusd_matrix4d_array_size(matrix4d_array) * 16 *
/// sizeof(double).
NANOUSD_API
...
///
/// @param matrix4d_array Valid matrix4d array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
...
///
/// @param uint64_array Valid uint64 array handle to destroy. Can be null
/// (no-op).
///
/// @note After calling this function, the array handle becomes invalid and must
/// not be used.
