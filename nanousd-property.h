...
/// @param property_type Output pointer that will contain the property's type on
/// success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_PROPERTY_PATH if no property exists at the
/// specified path
///
...
/// Gets the value of the given attribute as a token, if the attribute is of
/// that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param time_code The time at which to sample the attribute. If no value is
/// authored at this time,
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
...
/// Gets the value of the given attribute as a token array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param token_array Output pointer that will contain the token array handle
/// on success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
///
/// @note The returned token array must be released with
/// nusd_token_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
/// @note token_array must not be null.
NANOUSD_API
nusd_result_t nusd_attribute_get_token_array(
    nusd_stage_t stage,
    char const* attribute_path,
    double time_code,
    nusd_token_array_iterator_t* token_array_iterator);

// float
/// Gets the value of the given attribute as a float, if the attribute is of
/// that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Gets the value of the given attribute as a float array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param float_array Output pointer that will contain the float array handle
/// on success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
///
/// @note The returned float array must be released with
/// nusd_float_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as a 2-component float vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param time_code The time at which to sample the attribute. If no value is
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 2) that will contain the float2 values on
/// success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
/// @note stage must not be null.
/// @note attribute_path must not be null.
/// @note value must not be null and must point to an array of at least 2
/// floats.
NANOUSD_API
...
/// Gets the value of the given attribute as a float2 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param float2_array Output pointer that will contain the float2 array handle
/// on success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
///
/// @note The returned float2 array must be released with
/// nusd_float2_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as a 3-component float vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 3) that will contain the float3 values on
/// success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
/// @note stage must not be null.
/// @note attribute_path must not be null.
/// @note value must not be null and must point to an array of at least 3
/// floats.
NANOUSD_API
...
/// Gets the value of the given attribute as a float3 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param float3_array Output pointer that will contain the float3 array handle
/// on success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
///
/// @note The returned float3 array must be released with
/// nusd_float3_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as a 4-component float vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 4) that will contain the float4 values on
/// success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
/// @note stage must not be null.
/// @note attribute_path must not be null.
/// @note value must not be null and must point to an array of at least 4
/// floats.
NANOUSD_API
...
/// Gets the value of the given attribute as a float4 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param float4_array Output pointer that will contain the float4 array handle
/// on success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
///
/// @note The returned float4 array must be released with
/// nusd_float4_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Sets the value of the given attribute to a float, if the attribute is of
/// that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param value Float value to set.
/// @param time_code The time at which to set the attribute value. Use
/// NUSD_TIMECODE_DEFAULT
///                  for the default time. Time samples can be set even on
///                  uniform attributes.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
/// Sets the value of the given attribute to a float array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a 2-component float vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a 3-component float vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the float3 data to set (interleaved as
/// x,y,z,x,y,z,...).
...
/// Sets the value of the given attribute to a 4-component float vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the float4 data to set (interleaved as
/// x,y,z,w,x,y,z,w,...).
...
// double
/// Gets the value of the given attribute as a double, if the attribute is of
/// that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Gets the value of the given attribute as a double array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param double_array Output pointer that will contain the double array handle
/// on success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
///
/// @note The returned double array must be released with
/// nusd_double_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as a 2-component double vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 2) that will contain the double2 values on
/// success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
/// Gets the value of the given attribute as a double2 array, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param double2_array Output pointer that will contain the double2 array
/// handle on success.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
...
///
/// @note The returned double2 array must be released with
/// nusd_double2_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as a 3-component double vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 3) that will contain the double3 values on
/// success.
...
/// Gets the value of the given attribute as a double3 array, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param double3_array Output pointer that will contain the double3 array
/// handle on success.
...
///
/// @note The returned double3 array must be released with
/// nusd_double3_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as a 4-component double vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 4) that will contain the double4 values on
/// success.
...
/// Gets the value of the given attribute as a double4 array, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param double4_array Output pointer that will contain the double4 array
/// handle on success.
...
///
/// @note The returned double4 array must be released with
/// nusd_double4_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// double setters
/// Sets the value of the given attribute to a double, if the attribute is of
/// that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a double array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a 2-component double vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a 3-component double vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the double3 data to set (interleaved as
/// x,y,z,x,y,z,...).
...
/// Sets the value of the given attribute to a 4-component double vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the double4 data to set (interleaved as
/// x,y,z,w,x,y,z,w,...).
...
// int
/// Gets the value of the given attribute as an int, if the attribute is of that
/// type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Gets the value of the given attribute as an int array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param int_array Output pointer that will contain the int array handle on
/// success.
...
///
/// @note The returned int array must be released with nusd_int_array_destroy()
...
/// Gets the value of the given attribute as a 2-component int vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 2) that will contain the int2 values on
/// success.
...
/// Gets the value of the given attribute as an int2 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param int2_array Output pointer that will contain the int2 array handle on
/// success.
...
///
/// @note The returned int2 array must be released with
/// nusd_int2_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as a 3-component int vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 3) that will contain the int3 values on
/// success.
...
/// Gets the value of the given attribute as an int3 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param int3_array Output pointer that will contain the int3 array handle on
/// success.
...
///
/// @note The returned int3 array must be released with
/// nusd_int3_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as a 4-component int vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Output array (size 4) that will contain the int4 values on
/// success.
...
/// Gets the value of the given attribute as an int4 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param int4_array Output pointer that will contain the int4 array handle on
/// success.
...
///
/// @note The returned int4 array must be released with
/// nusd_int4_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// int64
/// Gets the value of the given attribute as an int64, if the attribute is of
/// that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Gets the value of the given attribute as an int64 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param int64_array Output pointer that will contain the int64 array handle
/// on success.
...
///
/// @note The returned int64 array must be released with
/// nusd_int64_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// int setters
/// Sets the value of the given attribute to an int, if the attribute is of that
/// type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to an int array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a 2-component int vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a 3-component int vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the int3 data to set (interleaved as
/// x,y,z,x,y,z,...).
...
/// Sets the value of the given attribute to a 4-component int vector, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the int4 data to set (interleaved as
/// x,y,z,w,x,y,z,w,...).
...
// int64 setters
/// Sets the value of the given attribute to an int64, if the attribute is of
/// that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to an int64 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
// bool
/// Gets the value of the given attribute as a bool, if the attribute is of that
/// type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Gets the value of the given attribute as a bool array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param bool_array Output pointer that will contain the bool array handle on
/// success.
...
///
/// @note The returned bool array must be released with
/// nusd_bool_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// matrix2d getters
/// Gets the value of the given attribute as a 2x2 matrix of doubles, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Pointer to array of 4 doubles to store the matrix values in
/// row-major order.
...
/// Gets the value of the given attribute as a matrix2d array, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
/// specified path
/// @return NUSD_RESULT_WRONG_TYPE if the attribute is not of matrix2d array
/// type
///
/// @note The returned matrix2d array must be released with
/// nusd_matrix2d_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// matrix3d getters
/// Gets the value of the given attribute as a 3x3 matrix of doubles, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Pointer to array of 9 doubles to store the matrix values in
/// row-major order.
...
/// Gets the value of the given attribute as a matrix3d array, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
/// specified path
/// @return NUSD_RESULT_WRONG_TYPE if the attribute is not of matrix3d array
/// type
///
/// @note The returned matrix3d array must be released with
/// nusd_matrix3d_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// matrix4d getters
/// Gets the value of the given attribute as a 4x4 matrix of doubles, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///                  returns an interpolated value based on neighboring time
///                  samples. Use NUSD_TIMECODE_DEFAULT for the default time.
/// @param value Pointer to array of 16 doubles to store the matrix values in
/// row-major order.
...
/// Gets the value of the given attribute as a matrix4d array, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
/// specified path
/// @return NUSD_RESULT_WRONG_TYPE if the attribute is not of matrix4d array
/// type
///
/// @note The returned matrix4d array must be released with
/// nusd_matrix4d_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// bool setters
/// Sets the value of the given attribute to a bool, if the attribute is of that
/// type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a bool array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
// matrix2d setters
/// Sets the value of the given attribute to a 2x2 matrix of doubles, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param value Pointer to array of 4 doubles containing matrix values in
/// row-major order.
/// @param time_code The time at which to set the attribute value. Use
/// NUSD_TIMECODE_DEFAULT
///                  for the default time. Time samples can be set even on
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the matrix2d data to set. Each matrix2d should be 4
/// consecutive doubles in row-major order.
...
/// @note stage must not be null.
/// @note attribute_path must not be null.
/// @note data must not be null and must point to at least num_elements * 4
/// doubles.
/// @note num_elements must be greater than 0.
NANOUSD_API
...
// matrix3d setters
/// Sets the value of the given attribute to a 3x3 matrix of doubles, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param value Pointer to array of 9 doubles containing matrix values in
/// row-major order.
/// @param time_code The time at which to set the attribute value. Use
/// NUSD_TIMECODE_DEFAULT
///                  for the default time. Time samples can be set even on
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the matrix3d data to set. Each matrix3d should be 9
/// consecutive doubles in row-major order.
...
/// @note stage must not be null.
/// @note attribute_path must not be null.
/// @note data must not be null and must point to at least num_elements * 9
/// doubles.
/// @note num_elements must be greater than 0.
NANOUSD_API
...
// matrix4d setters
/// Sets the value of the given attribute to a 4x4 matrix of doubles, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param value Pointer to array of 16 doubles containing matrix values in
/// row-major order.
/// @param time_code The time at which to set the attribute value. Use
/// NUSD_TIMECODE_DEFAULT
///                  for the default time. Time samples can be set even on
...
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param data Pointer to the matrix4d data to set. Each matrix4d should be 16
/// consecutive doubles in row-major order.
...
/// @note stage must not be null.
/// @note attribute_path must not be null.
/// @note data must not be null and must point to at least num_elements * 16
/// doubles.
/// @note num_elements must be greater than 0.
NANOUSD_API
...
// uint getters
/// Gets the value of the given attribute as an unsigned int, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Gets the value of the given attribute as a uint array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///
/// @note The returned uint array must be released with
/// nusd_uint_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// uint64 getters
/// Gets the value of the given attribute as an unsigned 64-bit int, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Gets the value of the given attribute as a uint64 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///
/// @note The returned uint64 array must be released with
/// nusd_uint64_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// uchar getters
/// Gets the value of the given attribute as an unsigned char, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Gets the value of the given attribute as a uchar array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///
/// @note The returned uchar array must be released with
/// nusd_uchar_array_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
// uint setters
/// Sets the value of the given attribute to an unsigned int, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a uint array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
// uint64 setters
/// Sets the value of the given attribute to an unsigned 64-bit int, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a uint64 array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
// uchar setters
/// Sets the value of the given attribute to an unsigned char, if the attribute
/// is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
/// Sets the value of the given attribute to a uchar array, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_NULL_PARAMETER if stage, attribute_path, or value is
/// null
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
/// specified path
/// @return NUSD_RESULT_WRONG_TYPE if the attribute is not of token type
...
/// @note attribute_path must not be null.
/// @note value must not be null.
/// @note Token attributes store string identifiers commonly used for shader
/// types, material bindings, and enumerated values.
NANOUSD_API
...
/// @param targets Output pointer that will contain the targets iterator handle
/// on success.
/// @param num_targets Optional output pointer that will contain the number of
/// targets (can be null).
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_INVALID_RELATIONSHIP_PATH if no relationship exists at
/// the specified path
///
/// @note The returned iterator must be released with
/// nusd_relationship_targets_iterator_destroy() when no longer needed.
/// @note stage must not be null.
...
/// Gets the value of the given attribute as an asset path, if the attribute is
/// of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
...
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_NULL_PARAMETER if stage, attribute_path, or asset_path
/// is null
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
/// specified path
/// @return NUSD_RESULT_WRONG_TYPE if the attribute is not of asset type
///
/// @note The returned asset path must be released with
/// nusd_asset_path_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// Gets the value of the given attribute as an asset path array, if the
/// attribute is of that type.
///
/// @param stage Valid stage handle.
/// @param attribute_path USD path to the attribute.
/// @param time_code Time code at which to get the value.
/// @param asset_path_array Output pointer that will contain the asset path
/// array iterator.
///
/// @return NUSD_RESULT_OK on success
/// @return NUSD_RESULT_NULL_PARAMETER if stage, attribute_path, or
/// asset_path_array is null
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if no attribute exists at the
/// specified path
/// @return NUSD_RESULT_WRONG_TYPE if the attribute is not of asset array type
///
/// @note The returned asset path array must be released with
/// nusd_asset_path_array_iterator_destroy() when no longer needed.
/// @note stage must not be null.
/// @note attribute_path must not be null.
...
/// @note attribute_path must not be null.
/// @note asset_path must not be null.
/// @note Asset attributes store file system paths or URIs to external assets
...
/// @note asset_path_array must not be null.
/// @note num_elements must be greater than 0.
/// @note Asset arrays store collections of file system paths or URIs to
/// external assets.
NANOUSD_API
nusd_result_t nusd_attribute_set_asset_array(nusd_stage_t stage,
                                             char const* attribute_path,
                                             char const** asset_path_array,
                                             size_t num_elements,
                                             double time_code);
...
/// "/World/Mesh.displayColor").
/// @param color_space The color space string to set (e.g., "sRGB", "linear",
/// "rec709").
/// @return NUSD_RESULT_OK on success.
/// @return NUSD_RESULT_NULL_PARAMETER if stage, attribute_path, or color_space
/// is null.
/// @return NUSD_RESULT_INVALID_ATTRIBUTE_PATH if the attribute path does not
/// exist.
/// @note Color space metadata is used by renderers to correctly interpret color
/// data.
